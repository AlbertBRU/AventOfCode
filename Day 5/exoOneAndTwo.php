...
foreach ($lineCoordinates as $line) {

  // Pour partir virtuellement sur un index de grille virtuelle de 1 à X
  $xOne = $line[0];
  $yOne = $line[1];
  $xTwo = $line[2];
  $yTwo = $line[3];
  ...
  $firstCoordinate = ($xOne + ($yOne*$linelength));
